...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        // Сортируем отрезки по началу (если равны, то по концу)
        Arrays.sort(segments);

        // Для каждой точки считаем количество камер, записавших событие
        for (int i = 0; i < m; i++) {
    ...
    // Метод для подсчета количества отрезков, содержащих точку
